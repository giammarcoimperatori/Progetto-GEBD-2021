...
//					System.out.println("\t\tpath dopo: "+path);
					
//					System.out.println("\n\n\t\tproteina aggiunta: ");
//					printProtein(n);
/*					key = new Tuple3<String, String, ArrayList<String>> (neigh, neigh,null);
					value = new Tuple3<Integer, String, ArrayList<Tuple2<String,String>>> (0,"GREY",null);
					n = new Protein(key,value);
					output.add(n);
*/				}
				}
