	...
	public static void main(String[] args) {
       ...
       /********************DATA LOADING & PREPROCESSING********************/
    	...
    	JavaPairRDD<String,String> Edges, EdgesOriginal;
			...
			list.add(new Tuple2<> ("1","2"));list.add(new Tuple2<> ("1","3"));list.add(new Tuple2<> ("1","5"));
	        list.add(new Tuple2<> ("2","3"));list.add(new Tuple2<> ("2","4"));list.add(new Tuple2<> ("2","5"));
	        list.add(new Tuple2<> ("3","4"));list.add(new Tuple2<> ("3","5"));
	        list.add(new Tuple2<> ("5","8"));
	        list.add(new Tuple2<> ("6","7"));list.add(new Tuple2<> ("6","9"));list.add(new Tuple2<> ("6","10"));
	        list.add(new Tuple2<> ("7","8"));list.add(new Tuple2<> ("7","9"));
	        list.add(new Tuple2<> ("8","10"));
	        list.add(new Tuple2<> ("9","10"));
		    Edges = jsc.parallelizePairs(list);
			EdgesOriginal = Edges;
		//Dataset reale
		System.out.println("\n\n\n"+
				      "\t\t\t    @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n"
